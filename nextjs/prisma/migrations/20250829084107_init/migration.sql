...
CREATE TABLE "public"."Source" (
    "Source_NId" SERIAL NOT NULL,
    "Source_GId" TEXT NOT NULL,
    "Source_Name" TEXT NOT NULL,

    CONSTRAINT "Source_pkey" PRIMARY KEY ("Source_NId")
);

-- CreateTable
CREATE TABLE "public"."Data" (
    "Data_NId" SERIAL NOT NULL,
    "IUSNId" INTEGER NOT NULL,
    "TimePeriod_NId" INTEGER NOT NULL,
    "Area_NId" INTEGER NOT NULL,
    "Data_Value" DECIMAL(65,30) NOT NULL,
    "Start_Date" TIMESTAMP(3),
    "End_Date" TIMESTAMP(3),
    "Date_Denominator" DECIMAL(65,30),
    "Source_NId" INTEGER NOT NULL,

    CONSTRAINT "Data_pkey" PRIMARY KEY ("Data_NId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "SubGroup_Subgroup_GId_key" ON "public"."SubGroup"("Subgroup_GId");

-- CreateIndex
CREATE UNIQUE INDEX "SubgroupVal_Subgroup_Val_key" ON "public"."SubgroupVal"("Subgroup_Val");

-- CreateIndex
CREATE UNIQUE INDEX "SubgroupVal_Subgroup_Val_GId_key" ON "public"."SubgroupVal"("Subgroup_Val_GId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Source_Source_GId_key" ON "public"."Source"("Source_GId");
...
-- AddForeignKey
ALTER TABLE "public"."SubGroupValSubgroups" ADD CONSTRAINT "SubGroupValSubgroups_Subgroup_Val_NId_fkey" FOREIGN KEY ("Subgroup_Val_NId") REFERENCES "public"."SubgroupVal"("Subgroup_Val_NId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."SubGroupValSubgroups" ADD CONSTRAINT "SubGroupValSubgroups_Subgroup_NId_fkey" FOREIGN KEY ("Subgroup_NId") REFERENCES "public"."SubGroup"("Subgroup_NId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Area" ADD CONSTRAINT "Area_Area_Parent_NId_fkey" FOREIGN KEY ("Area_Parent_NId") REFERENCES "public"."Area"("Area_NId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Data" ADD CONSTRAINT "Data_IUSNId_fkey" FOREIGN KEY ("IUSNId") REFERENCES "public"."IUS"("IUSNId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Data" ADD CONSTRAINT "Data_TimePeriod_NId_fkey" FOREIGN KEY ("TimePeriod_NId") REFERENCES "public"."TimePeriod"("TimePeriod_NId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Data" ADD CONSTRAINT "Data_Area_NId_fkey" FOREIGN KEY ("Area_NId") REFERENCES "public"."Area"("Area_NId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Data" ADD CONSTRAINT "Data_Source_NId_fkey" FOREIGN KEY ("Source_NId") REFERENCES "public"."Source"("Source_NId") ON DELETE RESTRICT ON UPDATE CASCADE;
