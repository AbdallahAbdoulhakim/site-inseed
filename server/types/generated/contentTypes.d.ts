...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredImages: Schema.Attribute.Media<'images' | 'videos', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
...
export interface ApiMainIndicatorMainIndicator
  ...
  info: {
    displayName: 'Main Indicator';
    pluralName: 'main-indicators';
    singularName: 'main-indicator';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::main-indicator.main-indicator'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<
      ['population', 'inflation', 'chomage', 'croissance', 'default']
    >;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    group: Schema.Attribute.Enumeration<['inseed', 'statcap']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'inseed'>;
